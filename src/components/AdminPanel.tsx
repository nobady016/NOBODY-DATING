...
export const AdminPanel: React.FC = () => {
  ...
  return (
    <div className="w-full max-w-md md:max-w-3xl lg:max-w-6xl xl:max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 pb-28 lg:pb-12 space-y-6 text-left">
      {/* Admin Header */}
      <div className="bg-[#0a0a0f] rounded-3xl border border-[#D4AF37]/30 p-6 space-y-4 relative overflow-hidden shadow-2xl">
        ...
        {/* Sub Navigation Tabs */}
        <div className="grid grid-cols-3 gap-1 bg-black p-1 rounded-full text-xs font-mono uppercase tracking-wider max-w-md">
          <button
          ...
          {reports.length === 0 ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {reports.map(r => {
                ...
                return (
                  <div key={r.id} className="bg-[#0a0a0f] border border-white/10 rounded-3xl p-5 space-y-3 flex flex-col justify-between">
      ...
      {activeTab === 'broadcast' && (
        <div className="bg-[#0a0a0f] rounded-3xl border border-white/10 p-6 space-y-4 max-w-2xl">
